  ...
  <div class="divBox">
    <el-card class="box-card" shadow="never">
      <el-form ref="formValidate" class="form" :model="formValidate" label-width="120px" :rules="ruleValidate" @submit.native.prevent>
        ...
        <el-row :gutter="2">
          <el-col :span="8">
            <el-form-item label="应用名称:" prop="name" label-for="name">
              <el-input v-model.trim="formValidate.values.name" placeholder="请输入微信小程序名称" clearable element-id="name" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开发key:" prop="app_key" label-for="app_key">
              <el-input v-model.trim="formValidate.values.app_key" placeholder="请输入微信小程序开发key" clearable element-id="app_key" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开发秘钥:" prop="app_secret" class="app-info" label-for="app_secret">
              <el-input v-model.trim="formValidate.values.app_secret" placeholder="请输入微信小程序开发密钥" clearable element-id="app_secret" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="2">
          <el-col :span="16">
            <el-form-item label="开发秘钥:">
              <el-input v-model.trim="formValidate.values.mini_secret" element-id="min-secrect" />
            </el-form-item>
          </el-col>
        </el-row>
        <div class="dividerTitle">
        ...
        <el-row :gutter="2">
          <el-col :span="8">
            <el-form-item label="应用名称:" prop="offical_name" label-for="offical_name">
              <el-input v-model.trim="formValidate.values.offical_name" placeholder="请输入公众号名称" clearable element-id="offical_name" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开发key:" prop="offical_app_key" label-for="offical_app_key">
              <el-input v-model.trim="formValidate.values.offical_app_key" placeholder="请输入公众号开发key" clearable element-id="offical_app_key" />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="开发秘钥:" prop="offical_app_secret" class="app-info" label-for="offical_app_secret">
              <el-input v-model.trim="formValidate.values.offical_app_secret" placeholder="请输入公众号开发秘钥" clearable element-id="offical_app_secret" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row :gutter="2">
          <el-col :span="16">
            <el-form-item label="开发秘钥:">
              <el-input v-model.trim="formValidate.values.office_secret" element-id="office-secret" />
            </el-form-item>
          </el-col>
        </el-row>
