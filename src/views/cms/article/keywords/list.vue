  ...
  <div class="divBox">
    <el-card class="box-card" shadow="never">
            ...
            <el-row>
              <el-col :span="19">
                <el-col v-bind="grid" style="width:auto;">
                  <el-form-item label="词语名称：" prop="title">
      ...
      >
        ...
        <el-table-column label="词语名称" align="center">
          <template slot-scope="{row}">
            {{ row.title }}
          </template>
        </el-table-column>
        <el-table-column label="显示顺序" prop="orders" align="center">
          <template slot-scope="{row}">
            {{ row.orders }}
          </template>
        </el-table-column>
    ...
    <div>
      ...
      >
        <el-form ref="form" :model="form" label-width="80px" :rules="rulesForm">
          <el-form-item prop="title" label="词语名称">
            <el-input
              v-model="form.title"
              placeholder="请输入词语名称"
              maxlength="32"
          ...
          <el-form-item prop="title" label="显示顺序">
            <el-input-number v-model="form.orders" :step="1" :max="1000" :min="1" />
          </el-form-item>
...
<script>
import { list, del, add, edit } from '@/api/article/keywords'
  ...
  data() {
    return {
      ...
      rulesForm: {
        ...
        title: [
          { required: true, message: '搜索词语名称不能为空', trigger: 'blur', max: 20 }
        ]
      }
    }
  },
