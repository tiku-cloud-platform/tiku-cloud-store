  ...
  <div class="divBox">
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <div class="container">
          <el-form ref="searchForm" :model="listQuery" inline size="small" label-position="right" label-width="100px">
            <el-row>
              <el-col :xs="24" :sm="24" :md="24" :lg="224" :xl="24">
      ...
      >
        ...
        <el-table-column label="选择题数" width="auto" align="center">
          <template slot-scope="{row}">
            <span>{{ row.option_sum }}</span>
          </template>
        </el-table-column>
        <el-table-column label="阅读题数" width="auto" align="center">
          <template slot-scope="{row}">
            <span>{{ row.reading_sum }}</span>
          </template>
        </el-table-column>
