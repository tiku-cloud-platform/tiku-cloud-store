  ...
  <div class="divBox">
    <el-card class="box-card" shadow="never">
      ...
      >
        ...
        <el-table-column label="签到积分" prop="code" align="center">
          <template slot-scope="{row}">
            {{ row.score }}
          </template>
        </el-table-column>
        ...
        <el-table-column label="是否连续" width="auto" align="center" :show-overflow-tooltip="true">
          <template slot-scope="{row}">
            <el-button v-if="row.is_continue === 2" size="mini" type="text" class="show-disable-text">否</el-button>
            <el-button v-if="row.is_continue === 1" size="mini" type="text" class="show-enable-text">是</el-button>
          </template>
        </el-table-column>
        <el-table-column label="签到描述" prop="remark" align="center" :show-overflow-tooltip="true">
          <template slot-scope="{row}">
            {{ row.remark }}
          </template>
        </el-table-column>
    ...
    <div>
      ...
      >
        <el-form ref="form" :model="form" label-width="80px" :rules="rulesForm">
          ...
          <el-form-item label="是否连续" prop="is_show">
            <el-radio-group v-model="form.is_continue">
              <el-radio :label="1">启用</el-radio>
              <el-radio :label="2">禁用</el-radio>
            </el-radio-group>
          </el-form-item>
