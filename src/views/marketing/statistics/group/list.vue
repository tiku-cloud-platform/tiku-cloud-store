    ...
    <el-card class="box-card" shadow="never">
        ...
        <div class="container">
          <el-form ref="searchFrom" v-model="listQuery" inline size="small" label-position="right">
              ...
              <el-col :span="19">
                <el-col v-bind="grid" style="width:auto;">
                  <el-form-item label="分组名称" prop="title">
                    <el-input v-model="listQuery.title" placeholder="请输入渠道分组名称" size="small" clearable />
                  </el-form-item>
                </el-col>
                <el-col v-bind="grid" style="width:auto;">
            ...
            <el-row>
              <el-col :span="5">
                <el-form-item>
                  <router-link :to="{path: '/marketing/marketing/group/save'}">
      ...
      >
        ...
        <el-table-column label="启用状态" width="auto" align="center" :show-overflow-tooltip="true">
          <template slot-scope="{row}">
            <el-button v-if="row.is_show === 2" size="text" type="text" class="show-disable-text">禁用</el-button>
            <el-button v-if="row.is_show === 1" size="text" type="text" class="show-enable-text">启用</el-button>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="150" class-name="small-padding fixed-width">
          <template slot-scope="{row,$index}">
            <router-link :to="{path: '/marketing/marketing/group/save/'+row.uuid}">
...
<script>
import { list, del } from '@/api/statistics/group'
